			...
			<div class="row-fluid">
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">添加课程</div>
					</div>
					<div class="block-content collapse in">
					<div class="row-fluid ">
						<div class="span12">
							<form class="form-horizontal" action="addcourseEntry.action"
								method="post">
								<fieldset>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="course.introduction" name="course.introduction" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="course.point">扣除点数（可选择）</label>
										<div class="controls">
											<input type="text" id="course.point" name="course.point" />
										</div>
									</div>
