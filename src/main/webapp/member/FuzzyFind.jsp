			...
			<div class="span12">
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						...
						<input type="text" id="fuzzyName" name="fuzzyName" placeholder="输入会员姓名..." />
...
<%-- 						<div class="pull-right"><span class="badge  badge-info">1,234</span>
					...
					<div class="block-content collapse in">
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach items="${requestScope.fuzzyfind}" var="m">
									<tr>
										...
										<td>${m.mobileNo }</td>
                                        <td>${m.address }</td>
                                       <td><a  href="memberupdate.action?id=${m.id}" class="btn btn-success">修改</a></td>
                                        <td><a href="memberdelete.action?id=${m.id}" class="btn btn-danger">删除</a></td>
