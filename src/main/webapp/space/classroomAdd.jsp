			...
			<div class="row-fluid">
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">添加教室</div>
					</div>
					<div class="block-content collapse in">
						<div class="span12">
							<form class="form-horizontal" action="./classroomAdd.action"
								method="post">
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="select01">瑜伽垫数量</label>
										<div class="controls">
										<input type="number" id="yogacushioncount" name="yogacushioncount"/>
										</div>
									</div>
